namespace ComputerNetworksProject.Constants
{
    ...
    public class Constant
    {
        ...
        public static DateTimeOffset CartMinLastUpdate { get => DateTime.Now.AddMinutes(-1); }

        public static readonly int ClearCartDelay = 30000;

        public static readonly int SentNotificationDelay = 60000;
